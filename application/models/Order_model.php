...
class Order_model extends CI_Model
{
    ...
    //         if ($default_tax['default_taxation_system'] == '0') {
    ...
    //         $final_total = floatval($total) + floatval($delivery_charge) + floatval($delivery_tip) + floatval($tax_amount) - floatval($promo_code_discount);
    //     } else {
    //         $final_total = floatval($total) + floatval($delivery_charge) + floatval($delivery_tip) - floatval($promo_code_discount);
    //     }
    ...
    //         }else{
    //             $final_total = $gross_total + $delivery_charge + $delivery_tip;
